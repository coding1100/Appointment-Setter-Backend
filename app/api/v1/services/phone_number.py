...
class PhoneNumberService:
    ...
    async def assign_phone_to_agent(self, tenant_id: str, agent_id: str, phone_number: str, twilio_integration_id: str) -> Dict[str, Any]:
        ...
        if existing_phone:
            ...
            phone_data = PhoneNumberCreate(
                ...
                agent_id=agent_id,
                twilio_integration_id=twilio_integration_id
            )
