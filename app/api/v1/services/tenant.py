...
from app.api.v1.schemas.tenant import (
    TenantCreate, TenantUpdate, BusinessInfoCreate, AgentSettingsCreate,
    TwilioIntegrationCreate, ServiceTypeCreate, AgentPolicyCreate
)
...
class TenantService:
    ...
    async def update_twilio_integration(self, tenant_id: str, twilio_data: TwilioIntegrationCreate) -> Optional[Dict[str, Any]]:
